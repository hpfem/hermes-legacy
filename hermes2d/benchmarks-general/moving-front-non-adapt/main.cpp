...
//  This benchmark has a time-dependent exact solution that is used to 
//  visualize the temporal integration error.
//
...
int main(int argc, char* argv[])
{
  ...
  ScalarView exact_view("Exact temporal error", new WinGeom(505, 0, 500, 400));
  exact_view.fix_scale_width(60);

  RungeKutta runge_kutta(&dp, &bt, matrix_solver);

  // Graph for time step history.
  SimpleGraph time_step_graph, err_exact_graph;
