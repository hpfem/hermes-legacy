...
class CustomRightHandSide_g1 : public HermesFunction, public CustomPiecewiseFunction
{
public:
  CustomRightHandSide_g1(double a, double b, const MaterialPropertyMaps& matprop, const std::string regions[])
    : HermesFunction(), CustomPiecewiseFunction(a, b, matprop, regions)
  {};
...
class CustomRightHandSide_g2 : public HermesFunction, public CustomPiecewiseFunction
{
public:
